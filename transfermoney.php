...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-black text-center"></a>
      ...
      <span class="navbar-toggler-icon" style="background:black;"></span>
       ...
       <div class="collapse navbar-collapse text-center" id="collapsenavbar">
          <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                  <a href="index.php" class="nav-link text-black">ABOUT</a></li>
              <li class="nav-item">
                  <a href="viewcustomers.php" class="nav-link text-black">VIEW CUSTOMER</a></li>
              <li class="nav-item">
                  <a href="transfermoney" class="nav-link text-black"></a></li>
              <li class="nav-item">
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:76px;background-color:#000000	;border-radius:10px;color:white" >
              <form method="POST">  
...
?> 
                    ...
                    <label>Name</label>
                        ...
                        <img src="29.png" style="width:130px;height:60px;">
                    </div>
          ...
          <div class="col-sm-4">
              <div class="card text-center" style="margin-top:60px;height:380px;">
                   <div class="card-body">
                   <img src="20.png" style="width:250px;height:220px;margin-top:40px;">
